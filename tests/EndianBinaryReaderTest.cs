...
namespace Apache.NMS.Test
{
	...
	public class EndianBinaryReaderTest
	{
		...
		public void testReadString16_UTF8Missing2ndByte()
		{
			...
			ActualValueDelegate<object> testDelegate = () => reader.ReadString16();

            Assert.That(testDelegate, Throws.TypeOf<IOException>());
        }
		...
		public void testReadString32_UTF8Missing2ndByte()
		{
			...
			ActualValueDelegate<object> testDelegate = () => reader.ReadString32();
